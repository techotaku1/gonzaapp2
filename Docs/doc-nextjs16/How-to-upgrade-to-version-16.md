...
Learn more in the [Next.js DevTools MCP documentation](/docs/app/guides/mcp.md).
...
Learn more about when to use `updateTag` or `revalidateTag` in the [updateTag documentation](/docs/app/api-reference/functions/updateTag.md#when-to-use-updatetag).
